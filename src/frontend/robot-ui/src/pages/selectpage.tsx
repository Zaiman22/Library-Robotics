  ...
  const Navigation = () => {
    return (
      <div className="bg-[#3db8dd] min-w-screen min-h-screen p-10 content-center">
        <h1 className="text-8xl font-extrabold text-center m-20">Apa yang bisa RoboBook bantu?</h1>
        ...
        <img src={micIcon} alt="Mic Icon" className='box size-80 my-35 bg-white rounded-full p-10 mx-auto' />
      </div>
    )
  }
